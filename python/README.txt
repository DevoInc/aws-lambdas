...
The files in this ZIP are needed in order to create the Lambda function that will send events in an S3 bucket to your Devo domain. Follow the instructions in:
